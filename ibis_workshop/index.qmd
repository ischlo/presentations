...
Reading OSM data with `QuakOSM` : [osm.ipynb](https://github.com/nismod/global-econ-data/blob/main/notebooks/osm.ipynb)

Reading and Processing the US Bureau of economic analysis data : [us_bea.ipynb](https://github.com/nismod/global-econ-data/blob/main/notebooks/us_bea.ipynb)
