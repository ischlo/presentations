...
for all j. If, we have a known underlying distribution at a finer scale, say $g_W(h_{ij}) = 18/105$ for $j=\{0,1,4,5,6\}$, and $g_W(h_{i2})=1/21,g_W(h_{i2})=2/21$, we incorporate this data into the equation and get:
