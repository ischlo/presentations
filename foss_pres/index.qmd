...
The urban environment has been extensively developed with vehicle use in mind, but this is changing in light of research indicating the negative impact that cars have on cities and their inhabitants. To name a few, noise and particle pollution, requirement for large parking space, collision danger [@hidalgoTrillionDollarStreets2020; @fleuryGeospatialAnalysisIndividualbased2021; @Saunders2013].
...
To perform the modelling step, a set of functions in R and C++ were developed as a package called **cppSim** and published on github and (hopefully) soon on CRAN.
